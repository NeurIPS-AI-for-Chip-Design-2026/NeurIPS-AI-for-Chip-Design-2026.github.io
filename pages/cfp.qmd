...
| Event | Date |
| --- | --- |
| Paper & Poster Submission | **August 31, 2026 (AoE)** |
...
**Submission portal:** [OpenReview](https://openreview.net/group?id=NeurIPS.cc/2026/Workshop/AI4ChipDesign)

Please use the official [NeurIPS 2026 style files](https://neurips.cc/Conferences/2026/PaperInformation/StyleFiles) and formatting guidelines.
...
## Submission Details {.panel-tabset}
...
- There is no limit on the length of appendices, but reviewers are encouraged not to take them into account for scoring the paper.
...
- All papers and posters are to be presented in person. Works which fail to have an in person presenter will be removed from the workshop.
